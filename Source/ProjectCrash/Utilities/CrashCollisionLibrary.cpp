...
bool UCrashCollisionLibrary::ConeTraceMulti(const UObject* WorldContextObject,
	const FVector Start,
	...
	float DrawTime)
{
	...
	const double ConeBaseRadius = ConeHeight * tan(ConeHalfAngleRad); // r = h * tan(theta / 2)
