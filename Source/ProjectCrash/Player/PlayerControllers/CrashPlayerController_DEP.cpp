...
void ACrashPlayerController_DEP::OnRep_PlayerState()
{
...
void ACrashPlayerController_DEP::InitializeUserInterface(const UUserInterfaceData* UIData)
{
...
UCommonActivatableWidget* ACrashPlayerController_DEP::PushWidgetToLayer(TSubclassOf<UCommonActivatableWidget> WidgetToPush, FGameplayTag LayerToPushTo)
{
...
void ACrashPlayerController_DEP::PopWidgetFromLayer(FGameplayTag LayerToPopFrom)
{
	// Search for the specified layer.
	for (UTaggedActivatableWidgetStack* WidgetLayer : GlobalLayeredWidgetLayers)
	{
...
UCommonActivatableWidget* ACrashPlayerController_DEP::PushWidgetToStack(TSubclassOf<UCommonActivatableWidget> WidgetToPush, FGameplayTag StackToPushTo)
{
	UCommonActivatableWidget* NewWidget = nullptr;
...
void ACrashPlayerController_DEP::PopWidgetFromStack(FGameplayTag StackToPopFrom)
{
	// Search for the specified stack.
	for (UTaggedActivatableWidgetStack* WidgetStack : LayerWidgetStacks)
	{
...
void ACrashPlayerController_DEP::AddWidgetToSlot(const FSlottedWidget& SlottedWidgetToCreate)
{
