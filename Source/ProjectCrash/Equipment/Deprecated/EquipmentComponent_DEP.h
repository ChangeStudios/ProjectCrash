...
#include "EquipmentComponent_DEP.generated.h"
 ...
 */
UCLASS()
class PROJECTCRASH_API UEquipmentComponent_DEP : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	static UEquipmentComponent_DEP* FindEquipmentComponent(const AActor* Actor) { return (Actor ? Actor->FindComponentByClass<UEquipmentComponent_DEP>() : nullptr); }
