...
#include "AAbilitySystemPhysicsVolume.generated.h"
...
protected:
	...
	/** Gameplay effects to apply to an actor when it leaves this volume. These will not be automatically removed by
	 * this volume. As such, they should either be duration-based or manually removed. */
	UPROPERTY(BlueprintReadWrite, Category = "Ability System|Gameplay Effects", EditAnywhere)
...
protected:
	...
	/** Gameplay abilities given to an actor when they enter this volume. These will not be automatically removed by
	 * this volume. */
	UPROPERTY(BlueprintReadWrite, Category = "Ability System|Gameplay Abilities", EditAnywhere)
...
protected:
	...
	/** Actors current inside this physics volume, mapped to a handle containing their temporarily granted abilities
