...
namespace CrashGameplayTags
{
	...
	PROJECTCRASH_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_AbilityBehavior_Slotted_Equipment);
	PROJECTCRASH_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_AbilityBehavior_Slotted_Generic);
	PROJECTCRASH_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_AbilityBehavior_Slotted_Weapon);
