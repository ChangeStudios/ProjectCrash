...
namespace CrashGameplayTags
{
	...
	PROJECTCRASH_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_AbilityBehavior_AbilityBar);
	PROJECTCRASH_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_AbilityBehavior_Ultimate);
	PROJECTCRASH_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_UI_AbilityBehavior_Weapon);
};
