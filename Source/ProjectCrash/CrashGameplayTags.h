...
namespace CrashGameplayTags
{
	...
	PROJECTCRASH_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Message_Ability_Disabled);
	PROJECTCRASH_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Message_Ability_Enabled);
