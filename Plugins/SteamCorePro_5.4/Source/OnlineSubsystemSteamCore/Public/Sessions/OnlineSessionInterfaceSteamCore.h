...
#include "OnlineSessionInterfaceSteamCore.generated.h"
...
UCLASS()
class ONLINESUBSYSTEMSTEAMCORE_API UOnlineSessionInterfaceSteamCoreUtils : public UObject
{
	GENERATED_BODY()
...
PACKAGE_SCOPE:
	...
	TArray<FUniqueNetIdSteamRef> GetJoinedLobbyList() const { return m_JoinedLobbyList; }
